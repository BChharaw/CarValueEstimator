A linear regression model to estimate the value of a vehicle using mileage, age, engine power, and transmission type using the CarDekho Vehicle Dataset with data cleaned in Google Sheets.
